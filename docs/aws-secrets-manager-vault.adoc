...
For more information about the syntax usabl, you can look at https://camel.apache.org/components/4.8.x/aws-secrets-manager-component.html#_using_aws_secrets_manager_property_function[AWS Secrets Manager Property Function]
